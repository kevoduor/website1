...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-['Inter']" style={{ fontFeatureSettings: '"liga" off, "calt" off' }}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <Link to="/login" className="text-emerald-600 px-3 py-2 text-sm font-medium">Login</Link>
              </div>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <Link to="/login" className="text-emerald-600 block px-3 py-2 text-base font-medium">Login</Link>
              </div>
            </div>
          )}
        </div>
      ...
      {/* Login Section */}
      <div className="bg-gradient-to-br from-emerald-50 via-white to-blue-50 min-h-screen py-20 px-4 flex items-center justify-center">
        <div className="max-w-md w-full">
          <Card className="shadow-2xl border-0 rounded-2xl overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white text-center py-8">
              <CardTitle className="text-3xl font-bold">Welcome Back</CardTitle>
              <p className="text-emerald-100 mt-2">Sign in to your Heynia account</p>
            </CardHeader>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 px-4 rounded-lg transition duration-200"
                  size="lg"
                >
                  Sign In
                </Button>
